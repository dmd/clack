Controller for the [KRUSH Flip Clock](https://web.archive.org/web/20170724225721/https://krushflipclock.com/), a [flip disc display](https://en.wikipedia.org/wiki/Flip-disc_display).
